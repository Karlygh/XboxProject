...
export class HomeCabecera implements OnInit {
  ...
  carouselData: CarouselItem[] = [
    { id: 1, title: 'Crysis', description: 'Advanced AI system for predictive analytics.', image: 'crysis.png', tech: ['TensorFlow', 'Python'] },
    { id: 2, title: 'Assassins Creed', description: 'Next-generation cloud infrastructure.', image: 'assasins.png', tech: ['AWS', 'Kubernetes'] },
    { id: 3, title: 'Budokai', description: 'Secure decentralized storage solution.', image: 'budokaii.png', tech: ['Ethereum', 'Solidity'] },
    { id: 4, title: 'FIFA 08', description: 'Military-grade cybersecurity framework.', image: 'fifa08.png', tech: ['Zero Trust', 'AI Defense'] },
    { id: 5, title: 'GTA 5', description: 'Big data processing platform.', image: 'gta4.png', tech: ['Apache Spark', 'Kafka'] },
    { id: 6, title: 'Red Dead', description: 'Augmented reality system for data visualization.', image: 'reddead.png', tech: ['Unity', 'ARCore'] },
    { id: 7, title: 'Resident Evil 5', description: 'Intelligent IoT ecosystem with edge computing.', image: 'residentevil.png', tech: ['MQTT', 'Edge AI'] },
    { id:8, title: 'Ufc 4', description:'Fighting',image:'ufc.png', tech:['Unreal Engine','C++']},
