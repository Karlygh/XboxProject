...
/**
 * Base de datos centralizada de todos los juegos
 * Esta es la ÚNICA fuente de verdad para los datos de juegos
 */

// Juegos EA Sports y partners
export const EA_GAMES: Game[] = [
  {
    id: 1,
    title: 'FIFA 26',
...
// Exclusivos de Xbox
export const XBOX_EXCLUSIVES: Game[] = [
  {
    id: 102,
...
// Juegos Carousel (clásicos)
export const CAROUSEL_GAMES: Game[] = [
  {
    id: 401,
    title: 'Crysis',
...
/**
 * Array consolidado de TODOS los juegos
 * Esta es la base de datos única para toda la aplicación
 */
